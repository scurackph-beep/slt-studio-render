...
// billing.js recibe acá el estado y los helpers compartidos. Las funciones que
// pasa se declaran más abajo, pero las declaraciones de función se elevan, así
// que ya existen en este punto.
initBilling({
  state,
  requestId,
  saveHistory,
